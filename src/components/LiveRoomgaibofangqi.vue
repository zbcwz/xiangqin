  ...
  <div>
    ...
    <div id="videoBox" ref="videoBoxref">
      <keep-alive>
        ...
        <ali-player v-once v-if="live.status == 1 && live.source != ''" id="aliplay" class="aliPlayer" :cover="live.cover"
          :source="live.source" :useH5Prism="true" :isLive="true" :playsinline="true" :height="aliplayerheight"
           controlBarVisibility="hover" :skinLayout="skinLayout"></ali-player>
      ...
      initRoomInfo: function() { //页面信息、直播信息、分享的初始化
        ...
        $.ajax({
          ...
          success: function(d) {
            ...
            self.live.cover = d.result.list.room.cover != "" ? d.result.list.room.cover : d.result.list.room.thumb;
